...
def compute_hourly_fee_split(
    ...
    fee_token0_raw = fg0 * liquidity * active_liq / 100.0
    fee_token1_raw = fg1 * liquidity * active_liq / 100.0
    ...
    fee_usdc = fee_usd_total * (t0_usd / total_raw_usd)
    fee_eth = (fee_usd_total * (t1_usd / total_raw_usd)) / close_price
